...
#docker exec  --interactive kafka-etl-app_broker_1 kafka-console-consumer --bootstrap-server broker:9092 --topic output_topic --group group_1 > processed_messages.json
#sleep 5
